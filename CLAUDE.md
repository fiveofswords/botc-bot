...
- `commands/help_types.py` - Enums for command categorization (sections, user types)
- `commands/help_commands.py` - Integrated help system (command + generation, replaces legacy help)
- `commands/info_commands.py` - Example registry-based commands
