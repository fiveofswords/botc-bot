        ...
        HelpSection.PLAYER: SectionInfo(
            ...
            commands=(
                ...
                HardcodedCommand("presetvote <<yes/no>>",
                                 "submits a preset vote. will not work if it is your turn to vote. not reccomended -- contact the storytellers instead",
                                 ("prevote",)),
                ...
                HardcodedCommand("makealias <<alias>> <<command>>", "creats an alias for a command"),
