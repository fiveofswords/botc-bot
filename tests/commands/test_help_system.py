...
class TestHelpSystem:
    ...
    def test_command_info_creation(self):
        """Test CommandInfo object creation."""
        ...
        assert info.help_sections == [HelpSection.MISC]
        assert info.user_types == [UserType.ALL]
        assert info.aliases == ["t"]

    def test_registry_get_commands_by_section(self):
        """Test getting commands by help section."""
        # Test commands should be registered from info_commands.py
        misc_commands = registry.get_commands_by_section(HelpSection.MISC, UserType.ALL)
    ...
    def test_registry_get_commands_by_user_type(self):
        ...
        all_commands = registry.get_commands_by_user_type(UserType.ALL)
    ...
    def test_help_generator_section_embed(self):
        ...
        misc_embed = HelpGenerator.create_section_help_embed(HelpSection.MISC, UserType.ALL)
    ...
    def test_registry_enhanced_command_decorator(self):
        ...
        assert UserType.ALL in cmd_info.user_types
    ...
    def test_enhanced_command_decorator_defaults(self):
        ...
        assert cmd_info.user_types == [UserType.ALL]
