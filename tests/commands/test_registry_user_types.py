...
class TestRegistryUserTypeDescriptions:
    ...
    def test_single_string_description(self):
        ...
        assert command_info.get_description_for_user(UserType.ALL) == "Simple command for everyone"
    ...
    def test_fallback_to_all_user_type(self):
        """Test fallback to UserType.ALL when specific type not found."""

        @self.registry.command(
            name="complex",
            description={
                UserType.STORYTELLER: "Storyteller-specific functionality",
                UserType.ALL: "General fallback description"
            },
        ...
        assert command_info.get_description_for_user(UserType.ALL) == "General fallback description"
    ...
    def test_missing_description_returns_empty_string(self):
        ...
        assert command_info.get_description_for_user(UserType.ALL) == ""
    ...
    def test_get_commands_by_user_type_with_specific_descriptions(self):
        ...
        @self.registry.command(
            ...
            description={
                ...
                UserType.ALL: "Fallback description"
            },
    ...
    def test_get_commands_by_section_with_user_types(self):
        ...
        player_day_commands = self.registry.get_commands_by_section(HelpSection.DAY, UserType.PLAYER)
        storyteller_day_commands = self.registry.get_commands_by_section(HelpSection.DAY, UserType.STORYTELLER)
    ...
    def test_realistic_vote_command_scenario(self):
        ...
        day_player_cmds = self.registry.get_commands_by_section(HelpSection.DAY, UserType.PLAYER)
        day_storyteller_cmds = self.registry.get_commands_by_section(HelpSection.DAY, UserType.STORYTELLER)
